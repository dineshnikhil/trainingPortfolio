...
function Home() {
    return (
        <div className="container-fluid home-div" id="home">
            <div className="row">
                <div className="col-lg-6 col-md-6 home-img-div" data-aos="zoom-in">
                ...
                <div className="col-lg-6 col-md-6 home-info-div">
                    <h1 data-aos="fade-up">Look And Feel Better With Personalized Training</h1>
                    <h4 data-aos="fade-up">Define your own goals and work towards them from anywhere, at any time, however you’d like.</h4>
